...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/system/etc/mixer_paths_VY52.xml:system/etc/mixer_paths_VY52.xml \
    $(LOCAL_PATH)/rootdir/system/etc/mixer_paths_VY55.xml:system/etc/mixer_paths_VY55.xml \
    $(LOCAL_PATH)/rootdir/system/etc/mixer_paths_VY58.xml:system/etc/mixer_paths_VY58.xml \
